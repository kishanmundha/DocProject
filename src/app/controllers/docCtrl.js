        ...
        (function () {
            ...
            app.controller('docCtrl', ['$log', '$scope', '$routeParams', '$sce', 'docService', '$timeout', '$anchorScroll', function ($log, $scope, $routeParams, $sce, docService, $timeout, $anchorScroll) {
                    $log.log('docCtrl');
                    ...
                    docService.getDocContent(projectId, docId, function (data) {
                        ...
                        $timeout(function () {
                            ...
                            $('#docOutput a[href^="/data/"').attr('target', '_self');

                            $('#docOutput a').each(function (e) {
                                $log.log(e);
                            });
                        }, 100);
                    });
